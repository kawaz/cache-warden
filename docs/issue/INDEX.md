...
|---|---|---|---|---|
| 2026-06-14 | idea | wip | [graceful-restart-state-handoff](./2026-06-14-graceful-restart-state-handoff.md) | **そもそも kv を維持したい根本理由 = op の TouchID サイクルに引き戻されたくない**。 |
...
| 2026-07-09 | design | idea | [graceful-restart-phase2-brew-upgrade-integration](./2026-07-09-graceful-restart-phase2-brew-upgrade-integration.md) | DR-0029 Phase 1 の後継。brew upgrade 完了時に daemon restart --graceful を自動呼び出しする。 |
