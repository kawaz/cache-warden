...
| 2026-07-11 | design | open | [approver-persistent-helper-lifecycle](./2026-07-11-approver-persistent-helper-lifecycle.md) | draft-DR-0031 Phase 1.4 の approver helper を「1 request=1 spawn」から常駐 accept ループへ組み替える設計判断 + IPC 残課題… |
